...
public class AppUtil {
        ...
        private static com.example.money_way.utils.AppUtil instance = null;

        private AppUtil(){}

        public static com.example.money_way.utils.AppUtil getInstance() {
            if (instance == null) {
                return new com.example.money_way.utils.AppUtil();
            }
            return instance;
        }
        ...
        private final Logger logger = LoggerFactory.getLogger(com.example.money_way.utils.AppUtil.class);
